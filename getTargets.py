...
# # print(soup.find)
# elem = browser.find_element_by_xpath('//*[@id="root"]/div/div/div/div/div/div/div[2]/div/div/div[3]/div[2]/div[4]/div[1]/span[2]/a[1]')
# print(elem.get_attribute("href"))
# browser.close()

# url = "http://nyzsjy.hynu.cn/"
# netloc = urlparse(url).netloc

browser = webdriver.Chrome(executable_path='/usr/local/bin/chromedriver2.3')
netlocs  = []
for url in shool_url:
    try:
        print("handling this ——"+str(url))
        browser.get(url)
        elem = browser.find_element_by_xpath('//*[@id="root"]/div/div/div/div/div/div/div[2]/div/div/div[3]/div[2]/div[4]/div[1]/span[2]/a[1]')
        netlocs.append(urlparse(elem.get_attribute("href")).netloc)
